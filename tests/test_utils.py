...
class TestLunarLocation:
    ...
    def test_permanently_shadowed_detection(self):
        ...
        psr = LunarLocation(
            name="PSR", latitude=-89.5, longitude=0.0, solar_exposure=0.05
        )
        sunlit = LunarLocation(
            name="Sunlit", latitude=0.0, longitude=0.0, solar_exposure=0.5
        )
...
class TestIntegration:
    ...
    def test_location_with_validation(self):
        ...
        location = LunarLocation(
            name="Test Site", latitude=45.0, longitude=90.0, avg_temp_c=-20.0
        )
