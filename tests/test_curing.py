...
class TestNumericalStability:
    ...
    def test_time_step_convergence(self):
        ...
        assert abs(profile_100.cure_fraction[-1] - 
                  profile_200.cure_fraction[-1]) < 0.01
...
class TestIntegration:
    ...
    def test_multi_temperature_comparison(self):
        ...
        assert all(final_cures[i] <= final_cures[i+1] 
                  for i in range(len(final_cures)-1))
