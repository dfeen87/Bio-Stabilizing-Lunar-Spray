...
class TestSprayParameters:
    ...
    def test_custom_parameters(self):
        ...
        params = SprayParameters(
            pressure_psi=30.0, ambient_temp_c=20.0, surface_slope=10.0
        )
...
class TestSprayDynamics:
    ...
    def simulator(self):
        ...
        params = SprayParameters(
            pressure_psi=25.0, ambient_temp_c=0.0, surface_slope=0.0
        )
    ...
    def test_expansion_time_array_length(self, simulator):
        ...
        results = simulator.simulate_radial_expansion(
            volume_ml=500, time_steps=time_steps
        )
    ...
    def test_expansion_reaches_max_radius(self, simulator):
        ...
        results = simulator.simulate_radial_expansion(volume_ml=500, duration_s=60.0)
    ...
    def test_calculate_optimal_volume(self, simulator):
        ...
        volume = simulator.calculate_optimal_volume(
            target_area_m2=target_area, target_thickness_mm=target_thickness
        )
...
class TestIntegration:
    ...
    def test_full_simulation_workflow(self):
        ...
        # Setup
        params = SprayParameters(
            pressure_psi=25.0, ambient_temp_c=0.0, surface_slope=5.0
        )
        simulator = SprayDynamics(params)

        # Run simulation
        results = simulator.simulate_radial_expansion(
            volume_ml=500, duration_s=30.0, time_steps=100
        )
...
class TestNumericalStability:
    ...
    def test_time_step_independence(self):
        ...
        results_100 = simulator.simulate_radial_expansion(volume_ml=500, time_steps=100)
        results_200 = simulator.simulate_radial_expansion(volume_ml=500, time_steps=200)
