...
class NutrientReleaseSimulator:
    ...
    def __init__(self, initial_ph: float = 10.0, water_availability: float = 1.0):
        """
    ...
    def check_plant_readiness(
        self, profile: NutrientProfile, requirements: Optional[PlantRequirements] = None
    ...
    def plot_nutrient_profiles(
        ...
        ax1.plot(
            profile.time_days,
            profile.concentrations[Nutrient.NITROGEN],
            "g-",
            linewidth=2,
            label="Nitrogen (N)",
        )
        ax1.plot(
            profile.time_days,
            profile.concentrations[Nutrient.PHOSPHORUS],
            "purple",
            linewidth=2,
            label="Phosphorus (P)",
        )
        ax1.plot(
            profile.time_days,
            profile.concentrations[Nutrient.POTASSIUM],
            "b-",
            linewidth=2,
            label="Potassium (K)",
        )
        ...
        ax2.plot(
            profile.time_days,
            profile.concentrations[Nutrient.MAGNESIUM],
            "orange",
            linewidth=2,
            label="Magnesium (Mg)",
        )
        ax2.plot(
            profile.time_days,
            profile.concentrations[Nutrient.SULFUR],
            "gold",
            linewidth=2,
            label="Sulfur (S)",
        )
        ax2.plot(
            profile.time_days,
            profile.concentrations[Nutrient.CALCIUM],
            "brown",
            linewidth=2,
            label="Calcium (Ca)",
        )
